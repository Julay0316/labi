...
nohup java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS com.labi.itfin.api.user.center.MainApplication > $STDOUT_FILE 2>&1 &
